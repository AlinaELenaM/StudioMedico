...
public class PazienteNoMedicoResponseDto {
    private Long id;
    private String nome;
    ...
    public PazienteNoMedicoResponseDto(Long id, String nome, String cognome, String email, String contattoTelefonico, String codiceFiscale, String indirizzo, String allergie, String storicoMalattie, List<AppuntamentoMinimalNoPazienteResponseDto> listaAppuntamenti) {
        this.id = id;
        this.nome = nome;
